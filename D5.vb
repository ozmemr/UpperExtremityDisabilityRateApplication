...
Public Class D5
    ...
    Private Sub D5_Load() Handles MyBase.Load
        'Ekranın ortasına al ********************************************************
        Me.AutoSize = True
    ...
    Private Sub Raporla()
        ...
        Dim Newline As String
        Newline = System.Environment.NewLine
        strParmakLokalRapor = "***D5*** " + Newline
        strParmakDIF = ""
        strParmakPIF = ""
        strParmakMKF = ""
        strParmakSorunları = ""
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles btnSaveExit.Click
        If leftside = True Then
            intD5FinalLeft = intLokalOzurlulukPuani
            strD5RaporFinalLeft = strParmakLokalRapor
        Else
            intD5FinalRight = intLokalOzurlulukPuani
            strD5RaporFinalRight = strParmakLokalRapor
        End If
