...
Public Class D2
    ...
    Private Sub D2_Load() Handles MyBase.Load
        'Ekranın ortasına al ********************************************************
        Me.AutoSize = True
    ...
    Private Sub Raporla()
        ...
        Dim Newline As String
        Newline = System.Environment.NewLine
        strParmakLokalRapor = "***D2*** " + Newline
        strParmakDIF = ""
        strParmakPIF = ""
        strParmakMKF = ""
        strParmakSorunları = ""
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles btnSaveExit.Click
        If leftside = True Then
            intD2FinalLeft = intLokalOzurlulukPuani
            strD2RaporFinalLeft = strParmakLokalRapor
        Else
            intD2FinalRight = intLokalOzurlulukPuani
            strD2RaporFinalRight = strParmakLokalRapor
        End If
    ...
    Private Sub listboxParmakTenosinovit_SelectedIndexChanged(sender As Object, e As EventArgs) Handles listboxParmakTenosinovit.SelectedIndexChanged
