...
Public Class D4
    ...
    Private Sub D4_Load() Handles MyBase.Load
        'Ekranın ortasına al ********************************************************
        Me.AutoSize = True
    ...
    Private Sub Raporla()
        ...
        Dim Newline As String
        Newline = System.Environment.NewLine
        strParmakLokalRapor = "***D4*** " + Newline
        strParmakDIF = ""
        strParmakPIF = ""
        strParmakMKF = ""
        strParmakSorunları = ""
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles btnSaveExit.Click
        If leftside = True Then
            intD4FinalLeft = intLokalOzurlulukPuani
            strD4RaporFinalLeft = strParmakLokalRapor
        Else
            intD4FinalRight = intLokalOzurlulukPuani
            strD4RaporFinalRight = strParmakLokalRapor
        End If
